...
#define INIT_SIZE 157
#define PROBE_LIMIT 27

enum Status { OCCUPIED, EMPTY, AVAILABLE };
...
public:
    ...
    Hashset(std::function<int(const T&)> hashcode) 
        : hashcode{hashcode}, store{new Element[INIT_SIZE]}, count{0} { }
